...
public class PromptDialog extends Dialog {
	...
	public static class Builder {
		...
		private PromptDialog.OnLinearClickListener linearListener;
		...
		public Builder setMessage(CharSequence message,PromptDialog.OnLinearClickListener listener) {
			this.message = message;
			this.linearListener=listener;
			return this;
		}

		public Builder setMessage(int messageResId,PromptDialog.OnLinearClickListener listener) {
			this.message = context.getResources().getString(messageResId);
			this.linearListener=listener;
			return this;
		}

		public Builder setMessage2(CharSequence message,PromptDialog.OnLinearClickListener listener) {
			this.message2 = message;
			this.linearListener=listener;
			return this;
		}

		public Builder setMessage2(int messageResId,PromptDialog.OnLinearClickListener listener) {
