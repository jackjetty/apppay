...
import com.ris.mobile.ecloud.widget.ApplySignPromptDialog.Builder;
...
public class  ApplyPayPromptDialog extends Dialog {
	...
	protected ApplyPayPromptDialog(Context context, int theme) {
		super(context, theme);
		this.context = context;
	}

	protected ApplyPayPromptDialog(Context context) {
		this(context, R.style.PromptDialogStyle);
	}

	protected ApplyPayPromptDialog(Context context, boolean cancelableOnTouchOutside) {
		this(context);
	...
	public static class Builder {
		...
		private ApplyPayPromptDialog dialog;
		private Context context;
		...
		private View view;
		private ApplyPayPromptDialog.OnClickListener button1Listener; 
		private ApplyPayPromptDialog.OnClickListener button2Listener;
		private ApplyPayPromptDialog.OnLinearClickListener linearListener;
	 
		 

		public Builder(Context context, int theme) {
			dialog = new ApplyPayPromptDialog(context, theme);
			this.context = context;
			initData();
		}

		public Builder(Context context) {
			dialog = new ApplyPayPromptDialog(context);
			this.context = context;
			initData();
		}
		...
		public Builder setPayNum(CharSequence payNum) {
			this.payNum = payNum;
			return this;
		}
		...
		public Builder setButton1(CharSequence text,
				ApplyPayPromptDialog.OnClickListener listener) {
		...
		@SuppressLint("InflateParams")
		public ApplyPayPromptDialog create() {
			...
			mView = LayoutInflater.from(context).inflate(
					R.layout.dialog_prompt_applypay, null);
			...
			*/
			...
			tvPayNum=(TextView) mView.findViewById(R.id.tv_PayNum);
		...
		public ApplyPayPromptDialog show() {
			create().show();
			return dialog;
		}
	}
