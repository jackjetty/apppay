...
public class CalendarHelper {
	...
	public static ArrayList<DateTime> getFullWeeks(int month, int year,
		...
		DateTime firstDateOfMonth = new DateTime(year, month, 1, 0, 0, 0, 0);//本月第一天
		DateTime lastDateOfMonth = firstDateOfMonth.plusDays(firstDateOfMonth
				.getNumDaysInMonth() - 1);//本月最后一天

		// Add dates of first week from previous month
		int weekdayOfFirstDate = firstDateOfMonth.getWeekDay();//第一天
		...
		// Add more weeks to fill remaining rows  加载下个月的天数
