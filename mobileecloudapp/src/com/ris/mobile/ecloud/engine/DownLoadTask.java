...
public class DownLoadTask implements Runnable {
	...
	private static final CommonLog Logger = LogFactory.createLog(TAG);
		...
		try {
			...
			while (threadCount != countSucess && flag && threadCount != stop) {
				...
				case DownMessage.MSG_SUCCESS:
					countSucess++;
					Logger.d(  "线程Id=" + msg.threadid + "已完成下载");
					break;
			...
			Logger.d(  "耗时" + (System.currentTimeMillis() - starttime));
