...
import com.rising.appserver.service.HotGameService;

@Controller
@RequestMapping("/hotgame")
public class GetHotGame extends BaseAction {

	Log log = LogFactory.getLog(GetHotGame.class);
	...
	public void getInfo(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			resultGson = hotGameService.getInfo(parameter,request);
	...
	public void getImage(HttpServletRequest request,
		...
		try {
			...
			String parameter = mapToString(paraMap);
			buffimage = hotGameService.getImage(parameter);
