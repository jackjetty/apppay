...
import com.rising.appserver.service.GetSalesInformationService;

@Controller
@RequestMapping("/salesInfo")
public class GetSalesInformation extends BaseAction {
	Log log = LogFactory.getLog(GetSalesInformation.class);
	
 
	@Autowired
	GetSalesInformationService getSalesInformationService;

	@RequestMapping("/get")
	public void getSalesInfo(HttpServletRequest request,
		...
		try {
			...
			resultGson = getSalesInformationService.getSalesInfoDetail(parameter,request);
