   ...
   // mRecyclerView.addOnScrollListener(new RecyclerViewOnScroll(this));
    ...
    public void setFooterViewBackgroundColor(int color) {
       // loadMoreLayout.setBackgroundColor(ContextCompat.getColor(mContext, color));
    	loadMoreLayout.setBackgroundColor(mContext.getResources().getColor(color));
    }
    ...
    public void setFooterViewTextColor(int color) {
        ...
        loadMoreText.setTextColor(mContext.getResources().getColor(color));
    }
    ...
    public void loadMore() {
    	System.out.println("123123123123"+mPullLoadMoreListener != null && hasMore);
    	System.out.println("12312312 3"+mPullLoadMoreListener != null );
    	System.out.println("123123123 "+  hasMore);
