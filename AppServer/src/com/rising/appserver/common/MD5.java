...
public class MD5 {
	...
	public static String  encryptByMD5WithFlow(String plainText){
		return  encryptByMD5With32Bit(plainText).toUpperCase();
	}
	...
	public static void main(String[] args) {
		...
		try {
			System.out.println(MD5.encryptByMD5("tangfuqiang"));
			//encryptByMD5With16Bit
			System.out.println(MD5.encryptByMD5With16Bit("admin"));
			System.out.println(MD5.encryptByMD5With32Bit("admin"));
			System.out.println(MD5.encryptByMD5WithFlow("bestpay"));
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
