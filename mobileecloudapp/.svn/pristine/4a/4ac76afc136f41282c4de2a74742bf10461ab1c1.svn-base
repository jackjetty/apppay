...
public class AbFileUtil {
	...
	public static void initFileDir(Context context){
				...
				//默认下载文件根目录. 
		String downloadRootPath = File.separator + "ecloud" + File.separator  + File.separator;
		
	    //默认下载图片文件目录. 
		String imageDownloadPath = downloadRootPath + "image"+ File.separator;
	    
	    //默认下载文件目录.
		String fileDownloadPath = downloadRootPath + "file" + File.separator;
		
		//默认缓存目录.
		String cacheDownloadPath = downloadRootPath + "cache" + File.separator;
		
		//默认DB目录.
		String dbDownloadPath = downloadRootPath +"db" + File.separator;
