...
public class  ICCardPromptDialog extends Dialog {
	...
	protected ICCardPromptDialog(Context context, int theme) {
		super(context, theme);
		this.context = context;
	}

	protected ICCardPromptDialog(Context context) {
		this(context, R.style.PromptDialogStyle);
	}

	protected ICCardPromptDialog(Context context, boolean cancelableOnTouchOutside) {
		this(context);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		int marginBorder = PhoneUtil.dip2px(context, 30);
	...
	public static class Builder {
		...
		private ICCardPromptDialog dialog;
		private Context context;
		...
		private CharSequence icCardNum;
		private CharSequence accountName;
		
		
		private CharSequence parName;
		private CharSequence chargeObj;
		...
		private View view;
		private ICCardPromptDialog.OnClickListener button1Listener; 
		private ICCardPromptDialog.OnClickListener button2Listener;
		private ICCardPromptDialog.OnLinearClickListener linearListener;
	 
		 

		public Builder(Context context, int theme) {
			dialog = new ICCardPromptDialog(context, theme);
			this.context = context;
			initData();
		}

		public Builder(Context context) {
			dialog = new ICCardPromptDialog(context);
			this.context = context;
			initData();
		}
		...
		public Builder setAccountName(CharSequence accountName) {
			this.accountName = accountName;
			return this;
		} 
		
		public Builder setICCardNum(CharSequence icCardNum) {
			this.icCardNum = icCardNum;
			return this;
		} 
		public Builder setChargeObj(CharSequence chargeObj) {
			this.chargeObj = chargeObj;
			return this;
		} 
		public Builder setParName(CharSequence parName) {
		...
		public Builder setButton1(CharSequence text,
				ICCardPromptDialog.OnClickListener listener) {
		...
		@SuppressLint("InflateParams")
		public ICCardPromptDialog create() {
			...
			TextView tvICCardNum=null;
			TextView tvAccountName=null;
			TextView tvParName=null;
			TextView tvChargeObj=null;
			...
			mView = LayoutInflater.from(context).inflate(
					R.layout.dialog_prompt_iccard, null);
			...
			*/
			...
			tvICCardNum=(TextView) mView.findViewById(R.id.tv_ICCardNum);
			tvParName=(TextView) mView.findViewById(R.id.tv_ParName);
			tvAccountName =(TextView) mView.findViewById(R.id.tv_AccountName);
		 
			tvChargeObj=(TextView) mView.findViewById(R.id.tv_ChargeObj);
			if(accountName!=null){
				tvAccountName.setText(accountName);
			}
			if(icCardNum!=null){
				tvICCardNum.setText(icCardNum);
			}
			if(parName!=null){
				tvParName.setText(parName);
			}
			
			if(chargeObj!=null){
				tvChargeObj.setText(chargeObj);
			}
		...
		public ICCardPromptDialog show() {
			create().show();
			return dialog;
		}
	}
