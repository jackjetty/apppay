...
public class DelEditText extends EditText implements OnFocusChangeListener,
		TextWatcher {
	private final static String TAG = "DelEditText";
	...
	private void init() {
		...
		if (mClearDrawable == null) {
			mClearDrawable = getResources().getDrawable(
					R.drawable.search_clear_normal);
		}
	...
	/*
	 * @Override public void setCompoundDrawables(Drawable left, Drawable top,
	 * Drawable right, Drawable bottom) { if(dLeft==null&&left !=null ) { dLeft
	 * = left; } super.setCompoundDrawables(left, top, right, bottom); }
	 */
	@Override
