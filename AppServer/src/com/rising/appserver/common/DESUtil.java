...
public class DESUtil {  
    ...
    public static String decryptMode(String key,String ciphertext ){
    	 try{
    		 byte[] enk = hex(key);
        	 
        	 byte[] reqPassword = Base64.decode(ciphertext);  
    ...
    public static void main(String[] args) throws Base64DecodingException {  
        ...
        String password = "123456213123111111zheshi111111111111117";//密码  
