...
public class OkHttpClientManager
{
     ...
     * @return
     */
    private Response _post(String url, Header[]  headers, Param... params) throws IOException
    {
     ...
     * @return 字符串
     */
    private String _postAsString(String url, Header[]  headers, Param... params) throws IOException
    {
    ...
    public static String postAsString(String url, Header[]  headers,Param... params ) throws IOException
    {
    ...
    private Request buildPostRequest(String url, Header[]  arrHeader, Param[] params)
    {
        ...
        for(Header header:arrHeader){
        	headers.put(header.getName(), CommonUtil.trim(header.getValue()));
